				...
				if($result){
					...
					while($vl = mysqli_fetch_assoc($result)){
                                                  echo('<tr>');
                                                    ...
                                                    echo('<td>'.$vl["post_id"].'</td>');
                                                    echo('<td>'.$vl["rprt_usr"].'</td>');
                                                    echo('<td>'.$vl["content"].'</td>');
                                                    echo('<td>'.$vl["dates"].'</td>');
                                                    echo('<form method="post">');
                                                    echo("<td><a href='remove_post.php?id=$vl[post_id]&rprt=$vl[id]' class='link-underline-danger'>Remove</a></td>");
